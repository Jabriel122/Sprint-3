...
//configuração do servidor de moderação de conteúdo - Azure
//Chabe e endepoint Azure
builder.Services.AddSingleton(provider => new ContentModeratorClient(
    new ApiKeyServiceClientCredentials("5edb644074aa4225881d47b665706cb9"))
{
    Endpoint = "https://eventmoderator-gabrielmarchetti.cognitiveservices.azure.com/"
}
);
